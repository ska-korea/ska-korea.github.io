...
<!-- ────────────────────────────────────────────────────────────
     영문 원고. 지금 구성에는 어울리지 않아 화면에 내보내지 않는다.
     지우지는 않는다 — 기존 홈페이지에 실려 있던 원고이고, 나중에
     영문 페이지를 따로 두게 되면 여기서 가져다 쓴다.
     다시 보이게 하려면 아래 <div>의 hidden 만 지우면 된다.
     ──────────────────────────────────────────────────────────── -->
